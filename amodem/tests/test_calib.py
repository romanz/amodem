...
#    scope="module",
#    params=[0]
#    + [sign * mag for sign in (+1, -1) for mag in
#    (0.1, 1, 10, 100, 1e3, 2e3)],
# )
# def freq_err(request):
#    """Freq_Err Fixture Docstring"""
...
def test_drift():
    drift_params = [0.0] + [
        sign * mag * 1.0e-6
        for sign in (+1.0, -1.0)
        for mag in (0.1, 1.0, 10.0, 100.0, 1.0e3, 2.0e3)
    ]
    for freq_err in drift_params:
